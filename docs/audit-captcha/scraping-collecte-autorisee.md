...
## 3. Architecture recommandée — collecte conforme
...
## 4. Garde-fous obligatoires pour les agents IA

Les agents navigateur autonomes (Browser Use, Stagehand) exigent un encadrement strict :
...
> Conditions : (1) validation juridique (AGPL en priorité), (2) garde-fous agents IA du §4, (3) base légale de collecte documentée par source.
